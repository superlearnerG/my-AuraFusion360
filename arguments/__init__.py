...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.dilate_mask_kernel_size = 10
        self.dilate_mask_iter = 1
        
        # for spinnerf dataset
        self.is_forward_facing = False
        self.specified_ply_path = None
        self.load_mask = True
        ...
        self.unseen_mask_dir = ""
        self.unseen_mask_dilated_dir = ""
        self.reference_dir = ""
        self.use_reference_images = False
        self.keep_all_unseen_components = False
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.optimize_is_masked_iter = 20000
        self.optimize_is_seen_iter = 20000
