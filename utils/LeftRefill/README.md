...
and place it at ```../pretrained_models/stable-diffusion-2-inpainting/512-inpainting-ema.safetensors``` relative to the AuraFusion360 project root. The loader also supports the original ```.ckpt``` filename if that file is present.
